...
// метод упорядочивания по убыванияю строк массива

int[,] Arithmetic_mean(int[,] array)
{
    int length_0 = array.GetLength(0);
    int length_1 = array.GetLength(1);
    for (int i = 0; i < length_0; i++)
...
PrintArray(array);
int [,] array_new = Arithmetic_mean(array);
Console.WriteLine("После сорировки массив имеет вид:");
PrintArray(array);
